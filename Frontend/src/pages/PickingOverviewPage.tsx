  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-sm font-black text-black dark:text-white ">Picking Queue</h1>
          <p className="text-[9px] font-bold text-neutral-400 uppercase tracking-tighter">Assigned fulfillment tasks for today</p>
        </div>
      </div>

      <CustomTable<PickList>
        columns={columns}
        data={data}
        page={page}
        pageSize={10}
